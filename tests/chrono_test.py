...
def test_create_individual_xrefs(test_input: str, expected: str | int | bool) -> None:
    a = Chronology('test')
...
@pytest.mark.parametrize('test_input,expected', testdata_family_xref)  # noqa: PT006
def test_create_individual_xrefs(test_input: str, expected: str | int | bool) -> None:
    a = Chronology('test')
    # Create the family xref.
...
# @pytest.mark.parametrize('test_input,expected', testdata_fam_xref)  # noqa: PT006
# def test_create_individual_xrefs(test_input: str, expected: str | int | bool) -> None:
#     a = Chronology('test')
