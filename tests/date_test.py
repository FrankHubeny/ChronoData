...
def test_date(test_input: str, expected: str | int | bool) -> None:
    ...
    creation_pieces: list = a.creation_date()
    #change: str = a.change_date()
    change_pieces: list = a.change_date()
    iso: str = a.iso_date(date, time)
    datevalue1 = a.date_value('01 JAN 2000')
    datevalue2 = a.date_value('01 JAN 2000', '01:01:01')
    datevalue3 = a.date_value('01 JAN 2000', phrase='hello')
    datevalue4 = a.date_value('01 JAN 2000', '01:01:01', 'hello')
    datevalue5 = a.date_value('01 JAN 2000', phrase='hello', level=5)
    datetime = a.now()
