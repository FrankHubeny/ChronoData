...
def test_bad_payload_Abbr() -> None:
    ...
    m = gc.Abbr(-1)  # type: ignore[arg-type]
    with pytest.raises(
...
def test_bad_payload_Addr() -> None:
    ...
    m = gc.Addr(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_AdopFamc() -> None:
    ...
    m = gc.AdopFamc(-1)  # type: ignore[arg-type]
    with pytest.raises(
...
def test_bad_payload_Adop() -> None:
    ...
    m = gc.Adop(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Adr1() -> None:
    ...
    m = gc.Adr1(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Adr2() -> None:
    ...
    m = gc.Adr2(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Adr3() -> None:
    ...
    m = gc.Adr3(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Age() -> None:
    ...
    m = gc.Age(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Agnc() -> None:
    ...
    m = gc.Agnc(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Alia() -> None:
    ...
    m = gc.Alia(-1)  # type: ignore[arg-type]
    with pytest.raises(
...
def test_bad_payload_Anci() -> None:
    ...
    m = gc.Anci(-1)  # type: ignore[arg-type]
    with pytest.raises(
...
def test_bad_payload_Anul() -> None:
    ...
    m = gc.Anul(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Asso() -> None:
    ...
    m = gc.Asso(-1, gc.Role('CHIL'))  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_INDIVIDUAL_XREF.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Auth() -> None:
    ...
    m = gc.Auth(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Bapm() -> None:
    ...
    m = gc.Bapm(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Barm() -> None:
    ...
    m = gc.Barm(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Basm() -> None:
    ...
    m = gc.Basm(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Birt() -> None:
    ...
    m = gc.Birt(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Bles() -> None:
    ...
    m = gc.Bles(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Buri() -> None:
    ...
    m = gc.Buri(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Caln() -> None:
    ...
    m = gc.Caln(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Cast() -> None:
    ...
    m = gc.Cast(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Caus() -> None:
    ...
    m = gc.Caus(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Chil() -> None:
    ...
    m = gc.Chil(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_INDIVIDUAL_XREF.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Chr() -> None:
    ...
    m = gc.Chr(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Chra() -> None:
    ...
    m = gc.Chra(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_City() -> None:
    ...
    m = gc.City(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Conf() -> None:
    ...
    m = gc.Conf(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Copr() -> None:
    ...
    m = gc.Copr(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Corp() -> None:
    ...
    m = gc.Corp(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Crem() -> None:
    ...
    m = gc.Crem(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Ctry() -> None:
    ...
    m = gc.Ctry(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_DataEvenDate() -> None:
    ...
    m = gc.DataEvenDate(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_DataEven() -> None:
    ...
    m = gc.DataEven(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_DateExact() -> None:
    ...
    m = gc.DateExact(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Date() -> None:
    ...
    m = gc.Date(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Deat() -> None:
    ...
    m = gc.Deat(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Desi() -> None:
    ...
    m = gc.Desi(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_SUBMITTER_XREF.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Dest() -> None:
    ...
    m = gc.Dest(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Div() -> None:
    ...
    m = gc.Div(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Divf() -> None:
    ...
    m = gc.Divf(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Dscr() -> None:
    ...
    m = gc.Dscr(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Educ() -> None:
    ...
    m = gc.Educ(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Email() -> None:
    ...
    m = gc.Email(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Emig() -> None:
    ...
    m = gc.Emig(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Enga() -> None:
    ...
    m = gc.Enga(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_ExidType() -> None:
    ...
    m = gc.ExidType(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Exid() -> None:
    ...
    m = gc.Exid(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_FamCens() -> None:
    ...
    m = gc.FamCens(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_FamEven() -> None:
    ...
    m = gc.FamEven(-1, gc.Type('abc'))  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_FamFact() -> None:
    ...
    m = gc.FamFact(-1, gc.Type('abc'))  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_FamHusb() -> None:
    ...
    m = gc.FamHusb(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_INDIVIDUAL_XREF.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_FamNchi() -> None:
    ...
    m = gc.FamNchi(-1)  # type: ignore[arg-type]
    with pytest.raises(
...
def test_bad_payload_FamResi() -> None:
    ...
    m = gc.FamResi(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_FamWife() -> None:
    ...
    m = gc.FamWife(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_INDIVIDUAL_XREF.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_FamcAdop() -> None:
    ...
    m = gc.FamcAdop(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_FamcStat() -> None:
    ...
    m = gc.FamcStat(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Famc() -> None:
    ...
    m = gc.Famc(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_FAMILY_XREF.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Fams() -> None:
    ...
    m = gc.Fams(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_FAMILY_XREF.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Fax() -> None:
    ...
    m = gc.Fax(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Fcom() -> None:
    ...
    m = gc.Fcom(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_FileTran() -> None:
    ...
    m = gc.FileTran(-1, gc.Form('text/html'))  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_File() -> None:
    ...
    m = gc.File(-1, gc.Form('text/html'))  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Form() -> None:
    ...
    m = gc.Form(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_GedcVers() -> None:
    ...
    m = gc.GedcVers(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Givn() -> None:
    ...
    m = gc.Givn(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Grad() -> None:
    ...
    m = gc.Grad(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_HeadDate() -> None:
    ...
    m = gc.HeadDate(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_HeadLang() -> None:
    ...
    m = gc.HeadLang(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_HeadPlacForm() -> None:
    ...
    m = gc.HeadPlacForm(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_HeadSourData() -> None:
    ...
    m = gc.HeadSourData(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_HeadSour() -> None:
    ...
    m = gc.HeadSour(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Height() -> None:
    ...
    m = gc.Height(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_INTEGER.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Idno() -> None:
    ...
    m = gc.Idno(-1, gc.Type('abc'))  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Immi() -> None:
    ...
    m = gc.Immi(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_IndiCens() -> None:
    ...
    m = gc.IndiCens(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_IndiEven() -> None:
    ...
    m = gc.IndiEven(-1, gc.Type('abc'))  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_IndiFact() -> None:
    ...
    m = gc.IndiFact(-1, gc.Type('abc'))  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_IndiFamc() -> None:
    ...
    m = gc.IndiFamc(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_FAMILY_XREF.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_IndiName() -> None:
    ...
    m = gc.IndiName(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_IndiNchi() -> None:
    ...
    m = gc.IndiNchi(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_INTEGER.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_IndiReli() -> None:
    ...
    m = gc.IndiReli(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_IndiResi() -> None:
    ...
    m = gc.IndiResi(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_IndiTitl() -> None:
    ...
    m = gc.IndiTitl(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Lang() -> None:
    ...
    m = gc.Lang(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Lati() -> None:
    ...
    m = gc.Lati(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Left() -> None:
    ...
    m = gc.Left(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_INTEGER.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Long() -> None:
    ...
    m = gc.Long(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Marb() -> None:
    ...
    m = gc.Marb(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Marc() -> None:
    ...
    m = gc.Marc(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Marl() -> None:
    ...
    m = gc.Marl(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Marr() -> None:
    ...
    m = gc.Marr(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Mars() -> None:
    ...
    m = gc.Mars(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Medi() -> None:
    ...
    m = gc.Medi(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Mime() -> None:
    ...
    m = gc.Mime(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_NameTran() -> None:
    ...
    m = gc.NameTran(-1, gc.Lang('en-US'))  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_NameType() -> None:
    ...
    m = gc.NameType(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Name() -> None:
    ...
    m = gc.Name(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Nati() -> None:
    ...
    m = gc.Nati(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Natu() -> None:
    ...
    m = gc.Natu(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Nick() -> None:
    ...
    m = gc.Nick(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Nmr() -> None:
    ...
    m = gc.Nmr(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_INTEGER.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_NoDate() -> None:
    ...
    m = gc.NoDate(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_No() -> None:
    ...
    m = gc.No(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_NoteTran() -> None:
    ...
    m = gc.NoteTran(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Note() -> None:
    ...
    m = gc.Note(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Npfx() -> None:
    ...
    m = gc.Npfx(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Nsfx() -> None:
    ...
    m = gc.Nsfx(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Obje() -> None:
    ...
    m = gc.Obje(-1)  # type: ignore[arg-type]
    with pytest.raises(
...
def test_bad_payload_Occu() -> None:
    ...
    m = gc.Occu(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_OrdStat() -> None:
    ...
    m = gc.OrdStat(-1, gc.DateExact('1 JAN 2000'))  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Ordn() -> None:
    ...
    m = gc.Ordn(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Page() -> None:
    ...
    m = gc.Page(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Pedi() -> None:
    ...
    m = gc.Pedi(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Phon() -> None:
    ...
    m = gc.Phon(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Phrase() -> None:
    ...
    m = gc.Phrase(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_PlacForm() -> None:
    ...
    m = gc.PlacForm(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_PlacTran() -> None:
    ...
    m = gc.PlacTran(-1, gc.Lang('en-US'))  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Plac() -> None:
    ...
    m = gc.Plac(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Post() -> None:
    ...
    m = gc.Post(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Prob() -> None:
    ...
    m = gc.Prob(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Prop() -> None:
    ...
    m = gc.Prop(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Publ() -> None:
    ...
    m = gc.Publ(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Quay() -> None:
    ...
    m = gc.Quay(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_RecordSnote() -> None:
    ...
    m = gc.RecordSnote(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Refn() -> None:
    ...
    m = gc.Refn(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Reli() -> None:
    ...
    m = gc.Reli(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Repo() -> None:
    ...
    m = gc.Repo(-1)  # type: ignore[arg-type]
    with pytest.raises(
...
def test_bad_payload_Resn() -> None:
    ...
    m = gc.Resn(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Reti() -> None:
    ...
    m = gc.Reti(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Role() -> None:
    ...
    m = gc.Role(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Sdate() -> None:
    ...
    m = gc.Sdate(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Sex() -> None:
    ...
    m = gc.Sex(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Snote() -> None:
    ...
    m = gc.Snote(-1)  # type: ignore[arg-type]
    with pytest.raises(
...
def test_bad_payload_SourEven() -> None:
    ...
    m = gc.SourEven(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Sour() -> None:
    ...
    m = gc.Sour(-1)  # type: ignore[arg-type]
    with pytest.raises(
...
def test_bad_payload_Spfx() -> None:
    ...
    m = gc.Spfx(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Ssn() -> None:
    ...
    m = gc.Ssn(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Stae() -> None:
    ...
    m = gc.Stae(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_SubmLang() -> None:
    ...
    m = gc.SubmLang(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Subm() -> None:
    ...
    m = gc.Subm(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_SUBMITTER_XREF.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Surn() -> None:
    ...
    m = gc.Surn(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Tag() -> None:
    ...
    m = gc.Tag(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Temp() -> None:
    ...
    m = gc.Temp(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Text() -> None:
    ...
    m = gc.Text(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Time() -> None:
    ...
    m = gc.Time(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Titl() -> None:
    ...
    m = gc.Titl(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Top() -> None:
    ...
    m = gc.Top(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_INTEGER.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Type() -> None:
    ...
    m = gc.Type(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Uid() -> None:
    ...
    m = gc.Uid(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Vers() -> None:
    ...
    m = gc.Vers(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Width() -> None:
    ...
    m = gc.Width(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_INTEGER.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Will() -> None:
    ...
    m = gc.Will(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
...
def test_bad_payload_Www() -> None:
    ...
    m = gc.Www(-1)  # type: ignore[arg-type]
    with pytest.raises(
        ValueError, match=re.escape(Msg.NOT_STRING.format('-1', m.class_name))
    ):
        assert m.validate()
