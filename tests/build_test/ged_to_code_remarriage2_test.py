# ged_to_code_remarriage2_test.py
"""Tests for the ged_to_code method."""

from genedata.build import Genealogy

remarriage2_file: str = 'tests/data/ged_examples/remarriage2.ged'

def test_ged_to_code_remarriage2() -> None:
...
fam_F3 = gc.RecordFam(fam_F3_xref, [
    gc.FamHusb(indi_I1_xref),
    gc.FamWife(indi_I2_xref),
    gc.Marr('', [
        gc.Date('4 JUL 1914'),
...
# Stage the 7 GEDCOM records to generate the ged lines.
g.stage(header)
g.stage(indi_I1)
g.stage(indi_I2)
g.stage(indi_I3)
