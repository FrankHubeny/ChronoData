# ged_to_code_escapes_test.py
"""Tests for the ged_to_code method."""

from genedata.build import Genealogy

escapes_file: str = 'tests/data/ged_examples/escapes.ged'

def test_ged_to_code_escapes() -> None:
...
# There were 8 cross reference identifiers.
