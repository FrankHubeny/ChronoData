...
testdata = [
    ...
    # calendars
    ('Calendar.GREGORIAN[Key.CALENDAR][Key.NAME]', 'GREGORIAN'),
    ('Calendar.GREGORIAN[Key.CALENDAR][Key.POSLABEL]', ' AD'),
    ('Calendar.GREGORIAN[Key.CALENDAR][Key.NEGLABEL]', ' BC'),
    #('Calendar.GREGORIAN[Key.ZEROYEAR]', -1970),
    #('Calendar.GREGORIAN[Key.USEZERO]', False),
    ('Calendar.SECULAR[Key.CALENDAR][Key.NAME]', 'SECULAR'),
    ('Calendar.SECULAR[Key.CALENDAR][Key.POSLABEL]', ' CE'),
    ('Calendar.SECULAR[Key.CALENDAR][Key.NEGLABEL]', ' BCE'),
    #('Calendar.SECULAR[Key.ZEROYEAR]', -1970),
    #('Calendar.SECULAR[Key.USEZERO]', False),
    ('Calendar.BEFORE_PRESENT[Key.CALENDAR][Key.NAME]', 'BEFORE PRESENT'),
    ('Calendar.BEFORE_PRESENT[Key.CALENDAR][Key.POSLABEL]', ''),
    ('Calendar.BEFORE_PRESENT[Key.CALENDAR][Key.NEGLABEL]', ' BP'),
    #('Calendar.BEFORE_PRESENT[Key.ZEROYEAR]', -1970),
    #('Calendar.BEFORE_PRESENT[Key.USEZERO]', False),
    ('Calendar.EXPERIMENT[Key.CALENDAR][Key.NAME]', 'EXPERIMENT'),
    ('Calendar.EXPERIMENT[Key.CALENDAR][Key.POSLABEL]', ''),
    ('Calendar.EXPERIMENT[Key.CALENDAR][Key.NEGLABEL]', ''),
