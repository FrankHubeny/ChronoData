...
Enumeration: dict[str, dict[str, Any]] = {
    'enum-0': {
        ...
        'standard tag': '0',
        'specification': ['Unreliable evidence or estimated data'],
        'value of': ['https://gedcom.io/terms/v7/enumset-QUAY'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-1': {
        'lang': 'en-US',
    ...
    'enum-ADOP-HUSB': {
        ...
        'value of': ['https://gedcom.io/terms/v7/enumset-ADOP'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-ADOP-WIFE': {
        'lang': 'en-US',
    ...
    'enum-ADOPTED': {
        ...
        'specification': ['Adoptive parents'],
        'value of': ['https://gedcom.io/terms/v7/enumset-PEDI'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-AKA': {
        'lang': 'en-US',
        ...
        'standard tag': 'AKA',
        'specification': ['Also known as, alias, etc.'],
        'value of': ['https://gedcom.io/terms/v7/enumset-NAME-TYPE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-AUDIO': {
        'lang': 'en-US',
        ...
        'standard tag': 'AUDIO',
        'specification': ['An audio recording'],
        'value of': ['https://gedcom.io/terms/v7/enumset-MEDI'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-BIC': {
        'lang': 'en-US',
        ...
        'value of': ['https://gedcom.io/terms/v7/enumset-ord-STAT'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-BIRTH': {
        'lang': 'en-US',
    ...
    'enum-CARD': {
        ...
        'standard tag': 'CARD',
        'specification': ['A card or file entry'],
        'value of': ['https://gedcom.io/terms/v7/enumset-MEDI'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-CENS': {
        ...
        'standard tag': 'CENS',
        'specification': [
            'A census event; either `https://gedcom.io/terms/v7/INDI-CENS` or `https://gedcom.io/terms/v7/FAM-CENS`'
        ],
        'value of': [
    ...
    'enum-CHALLENGED': {
        ...
        'value of': ['https://gedcom.io/terms/v7/enumset-FAMC-STAT'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-CHIL': {
        'lang': 'en-US',
        ...
        'standard tag': 'CHIL',
        'specification': ['Child'],
        'value of': ['https://gedcom.io/terms/v7/enumset-ROLE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-CHILD': {
        'lang': 'en-US',
        ...
        'specification': [
            ...
            'Died before 8 years old, so ordinances other than child to parent sealing are not required.',
            'Status: Current',
        ],
        'value of': ['https://gedcom.io/terms/v7/enumset-ord-STAT'],
        'contact': 'https://gedcom.io/community/',
    ...
    'enum-CLERGY': {
        ...
        'standard tag': 'CLERGY',
        'specification': ['Religious official in event; implies `OFFICIATOR`'],
        'value of': ['https://gedcom.io/terms/v7/enumset-ROLE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-COMPLETED': {
        ...
        'specification': [
            ...
            'Status: Deprecated, use `DATE BEF date` instead. This status was defined for use with [TempleReady] which is no longer in use.',
        ],
        'value of': ['https://gedcom.io/terms/v7/enumset-ord-STAT'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-CONFIDENTIAL': {
        ...
        'specification': ['This data was marked as confidential by the user.'],
        'value of': ['https://gedcom.io/terms/v7/enumset-RESN'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-DISPROVEN': {
        'lang': 'en-US',
    ...
    'enum-ELECTRONIC': {
        ...
        'specification': ['A digital artifact'],
        'value of': ['https://gedcom.io/terms/v7/enumset-MEDI'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-EVEN': {
        ...
        'standard tag': 'EVEN',
        'specification': [
            'A generic event; either `https://gedcom.io/terms/v7/INDI-EVEN` or `https://gedcom.io/terms/v7/FAM-EVEN`'
        ],
        'value of': ['https://gedcom.io/terms/v7/enumset-EVENATTR'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-EXCLUDED': {
        'lang': 'en-US',
        ...
        'specification': [
            ...
            'Status: Deprecated. This status was defined for use with TempleReady which is no longer in use.',
        ],
        'value of': ['https://gedcom.io/terms/v7/enumset-ord-STAT'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-F': {
        ...
        'standard tag': 'F',
        'specification': ['Female'],
        'value of': ['https://gedcom.io/terms/v7/enumset-SEX'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-FACT': {
        'lang': 'en-US',
        ...
        'standard tag': 'FACT',
        'specification': [
            'A generic attribute; either `https://gedcom.io/terms/v7/INDI-FACT` or `https://gedcom.io/terms/v7/FAM-FACT`'
        ],
        'value of': ['https://gedcom.io/terms/v7/enumset-EVENATTR'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-FATH': {
        ...
        'standard tag': 'FATH',
        'specification': ['Father; implies `PARENT`'],
        'value of': ['https://gedcom.io/terms/v7/enumset-ROLE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-FICHE': {
    ...
    'enum-GODP': {
        ...
        'standard tag': 'GODP',
        'specification': ['Godparent or related role in other religions'],
        'value of': ['https://gedcom.io/terms/v7/enumset-ROLE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-HUSB': {
        ...
        'standard tag': 'HUSB',
        'specification': ['Husband; implies `SPOU`'],
        'value of': ['https://gedcom.io/terms/v7/enumset-ROLE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-IMMIGRANT': {
        ...
        'specification': ['Name assumed at the time of immigration.'],
        'value of': ['https://gedcom.io/terms/v7/enumset-NAME-TYPE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-INFANT': {
    ...
    'enum-LOCKED': {
        ...
        'standard tag': 'LOCKED',
        'specification': ['Some systems may ignore changes to this data.'],
        'value of': ['https://gedcom.io/terms/v7/enumset-RESN'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-M': {
    ...
    'enum-MAGAZINE': {
        ...
        'specification': ['Printed periodical'],
        'value of': ['https://gedcom.io/terms/v7/enumset-MEDI'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-MAIDEN': {
        ...
        'standard tag': 'MAIDEN',
        'specification': ['Maiden name, name before first marriage.'],
        'value of': ['https://gedcom.io/terms/v7/enumset-NAME-TYPE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-MANUSCRIPT': {
    ...
    'enum-MAP': {
        ...
        'standard tag': 'MAP',
        'specification': ['Cartographic map'],
        'value of': ['https://gedcom.io/terms/v7/enumset-MEDI'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-MARRIED': {
        ...
        'specification': ['Married name, assumed as part of marriage.'],
        'value of': ['https://gedcom.io/terms/v7/enumset-NAME-TYPE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-MOTH': {
        ...
        'standard tag': 'MOTH',
        'specification': ['Mother; implies `PARENT`'],
        'value of': ['https://gedcom.io/terms/v7/enumset-ROLE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-MULTIPLE': {
    ...
    'enum-NCHI': {
        ...
        'standard tag': 'NCHI',
        'specification': [
            'A count of children; either `https://gedcom.io/terms/v7/INDI-NCHI` or `https://gedcom.io/terms/v7/FAM-NCHI`'
        ],
        'value of': ['https://gedcom.io/terms/v7/enumset-EVENATTR'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-NEWSPAPER': {
        ...
        'specification': ['Printed newspaper'],
        'value of': ['https://gedcom.io/terms/v7/enumset-MEDI'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-NGHBR': {
    ...
    'enum-OFFICIATOR': {
        ...
        'specification': ['Officiator of the event'],
        'value of': ['https://gedcom.io/terms/v7/enumset-ROLE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-OTHER': {
    ...
    'enum-PRE_1970': {
        ...
        'specification': [
            'Applies to: All',
            'Ordinance was likely completed because an ordinance for this person was converted from temple records of work completed before 1970.',
    ...
    'enum-PRIVACY': {
        ...
        'specification': [
            'This data is not to be shared outside of a trusted circle, generally because it contains information about living individuals. This definition is known to admit multiple interpretations, so use of the `PRIVACY` restriction notice is not recommended.'
        ],
        'value of': ['https://gedcom.io/terms/v7/enumset-RESN'],
        'contact': 'https://gedcom.io/community/',
    },
    ...
    'enum-PROVEN': {
        ...
        'standard tag': 'PROVEN',
        'specification': ['Linking this child to this family has been proven.'],
        'value of': ['https://gedcom.io/terms/v7/enumset-FAMC-STAT'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-RESI': {
        ...
        'standard tag': 'RESI',
        'specification': [
            'A residence attribute; either `https://gedcom.io/terms/v7/INDI-RESI` or `https://gedcom.io/terms/v7/FAM-RESI`'
        ],
        'value of': ['https://gedcom.io/terms/v7/enumset-EVENATTR'],
        'contact': 'https://gedcom.io/community/',
    },
    ...
    'enum-TOMBSTONE': {
        ...
        'specification': ['Burial marker or related memorial'],
        'value of': ['https://gedcom.io/terms/v7/enumset-MEDI'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-U': {
        ...
        'standard tag': 'U',
        'specification': ['Cannot be determined from available sources'],
        'value of': ['https://gedcom.io/terms/v7/enumset-SEX'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-UNCLEARED': {
    ...
    'enum-VIDEO': {
        ...
        'standard tag': 'VIDEO',
        'specification': ['Motion picture recording'],
        'value of': ['https://gedcom.io/terms/v7/enumset-MEDI'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-WIFE': {
        ...
        'standard tag': 'WIFE',
        'specification': ['Wife; implies `SPOU`'],
        'value of': ['https://gedcom.io/terms/v7/enumset-ROLE'],
        'contact': 'https://gedcom.io/community/',
    },
    'enum-WITN': {
...
Month: dict[str, dict[str, Any]] = {
    'month-AAV': {
        ...
        'standard tag': 'AAV',
        'specification': ['Av (אָב)'],
        'label': 'Av',
        'calendars': ['https://gedcom.io/terms/v7/cal-HEBREW'],
        'contact': 'https://gedcom.io/community/',
    },
    'month-ADR': {
        'lang': 'en-US',
        ...
        'standard tag': 'ADR',
        'specification': [
            'Adar I, Adar Rishon, First Adar, or Adar Aleph\xa0(אדר\xa0א׳)'
        ],
        'label': 'Adar I',
        'calendars': ['https://gedcom.io/terms/v7/cal-HEBREW'],
        'contact': 'https://gedcom.io/community/',
    ...
    'month-ADS': {
        ...
        'standard tag': 'ADS',
        'specification': [
            'Adar (אֲדָר); or Adar II, Adar Sheni, Second Adar, or Adar\xa0Bet\xa0(אדר\xa0ב׳)'
        ],
        'label': 'Adar',
        'calendars': ['https://gedcom.io/terms/v7/cal-HEBREW'],
        'contact': 'https://gedcom.io/community/',
    ...
    'month-BRUM': {
        ...
        'standard tag': 'BRUM',
        'specification': ['Brumaire'],
        'label': 'Brumaire',
        'calendars': ['https://gedcom.io/terms/v7/cal-FRENCH_R'],
        'contact': 'https://gedcom.io/community/',
    },
    'month-COMP': {
        'lang': 'en-US',
        ...
        'standard tag': 'COMP',
        'specification': ['Jour ComplÃ©mentaires'],
        'label': 'Jour ComplÃ©mentaires',
        'calendars': ['https://gedcom.io/terms/v7/cal-FRENCH_R'],
        'contact': 'https://gedcom.io/community/',
    },
    'month-CSH': {
        ...
        'standard tag': 'CSH',
        'specification': ['Marcheshvan (מַרְחֶשְׁוָן) or Cheshvan (חֶשְׁוָן)'],
        'label': 'Marcheshvan',
        'calendars': ['https://gedcom.io/terms/v7/cal-HEBREW'],
        'contact': 'https://gedcom.io/community/',
    },
    ...
    'month-KSL': {
        ...
        'standard tag': 'KSL',
        'specification': ['Kislev (×›Ö´Ö¼×¡Ö°×œÖµ×•)'],
        'label': 'Kislev',
        'calendars': ['https://gedcom.io/terms/v7/cal-HEBREW'],
        'contact': 'https://gedcom.io/community/',
    },
    ...
    'month-TMZ': {
        ...
        'standard tag': 'TMZ',
        'specification': ['Tammuz (×ªÖ·Ö¼×žÖ¼×•Ö¼×–)'],
        'label': 'Tammuz',
        'calendars': ['https://gedcom.io/terms/v7/cal-HEBREW'],
        'contact': 'https://gedcom.io/community/',
    },
    'month-TSH': {
        ...
        'standard tag': 'TSH',
        'specification': ['Tishrei (תִּשְׁרֵי)'],
        'label': 'Tishrei',
        'calendars': ['https://gedcom.io/terms/v7/cal-HEBREW'],
        'contact': 'https://gedcom.io/community/',
    },
...
Structure: dict[str, dict[str, Any]] = {
    'ABBR': {
        ...
        'substructures': {},
        'superstructures': {'https://gedcom.io/terms/v7/record-SOUR': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'ADDR': {
        'lang': 'en-US',
    ...
    'ADOP-FAMC': {
        ...
        'substructures': {'https://gedcom.io/terms/v7/FAMC-ADOP': '{0:1}'},
        'superstructures': {'https://gedcom.io/terms/v7/ADOP': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'ADOP': {
        'lang': 'en-US',
        ...
        'superstructures': {'https://gedcom.io/terms/v7/record-INDI': '{0:M}'},
        'value of': [
            'https://gedcom.io/terms/v7/enumset-EVEN',
            'https://gedcom.io/terms/v7/enumset-EVENATTR',
        ],
    ...
    'ADR1': {
        ...
        'payload': 'http://www.w3.org/2001/XMLSchema#string',
        'substructures': {},
        'superstructures': {'https://gedcom.io/terms/v7/ADDR': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'ADR2': {
        'lang': 'en-US',
    ...
    'ANUL': {
        ...
        'superstructures': {'https://gedcom.io/terms/v7/record-FAM': '{0:M}'},
        'value of': [
            'https://gedcom.io/terms/v7/enumset-EVEN',
            'https://gedcom.io/terms/v7/enumset-EVENATTR',
        ],
    ...
    'CALN': {
        ...
        'label': 'Call number',
        'payload': 'http://www.w3.org/2001/XMLSchema#string',
        'substructures': {'https://gedcom.io/terms/v7/MEDI': '{0:1}'},
        'superstructures': {'https://gedcom.io/terms/v7/REPO': '{0:M}'},
        'contact': 'https://gedcom.io/community/',
    },
    'CAST': {
        'lang': 'en-US',
    ...
    'CORP': {
        ...
        'superstructures': {'https://gedcom.io/terms/v7/HEAD-SOUR': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'CREA': {
        'lang': 'en-US',
    ...
    'CROP': {
        ...
        'superstructures': {'https://gedcom.io/terms/v7/OBJE': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'CTRY': {
        'lang': 'en-US',
    ...
    'DATA-EVEN-DATE': {
        ...
        'substructures': {'https://gedcom.io/terms/v7/PHRASE': '{0:1}'},
        'superstructures': {'https://gedcom.io/terms/v7/DATA-EVEN': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'DATA-EVEN': {
        'lang': 'en-US',
        ...
        'superstructures': {'https://gedcom.io/terms/v7/DATA': '{0:M}'},
        'contact': 'https://gedcom.io/community/',
    },
    'DATA': {
        'lang': 'en-US',
    ...
    'DATE-exact': {
        ...
        'substructures': {'https://gedcom.io/terms/v7/TIME': '{0:1}'},
        'superstructures': {
    ...
    'EXID-TYPE': {
        ...
        'payload': 'http://www.w3.org/2001/XMLSchema#string',
        'substructures': {},
        'superstructures': {'https://gedcom.io/terms/v7/EXID': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'EXID': {
        'lang': 'en-US',
        ...
        'payload': 'http://www.w3.org/2001/XMLSchema#string',
        'substructures': {'https://gedcom.io/terms/v7/EXID-TYPE': '{0:1}'},
        'superstructures': {
    ...
    'FAM-HUSB': {
        ...
        'payload': '@<https://gedcom.io/terms/v7/record-INDI>@',
        'substructures': {'https://gedcom.io/terms/v7/PHRASE': '{0:1}'},
        'superstructures': {'https://gedcom.io/terms/v7/record-FAM': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'FAM-NCHI': {
        'lang': 'en-US',
    ...
    'FAMC-ADOP': {
        ...
        'substructures': {'https://gedcom.io/terms/v7/PHRASE': '{0:1}'},
        'superstructures': {'https://gedcom.io/terms/v7/ADOP-FAMC': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'FAMC-STAT': {
        'lang': 'en-US',
        ...
        'substructures': {'https://gedcom.io/terms/v7/PHRASE': '{0:1}'},
        'superstructures': {'https://gedcom.io/terms/v7/INDI-FAMC': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'FAMC': {
        'lang': 'en-US',
    ...
    'FILE-TRAN': {
        ...
        'substructures': {'https://gedcom.io/terms/v7/FORM': '{1:1}'},
        'superstructures': {'https://gedcom.io/terms/v7/FILE': '{0:M}'},
        'contact': 'https://gedcom.io/community/',
    },
    'FILE': {
        'lang': 'en-US',
        ...
        'superstructures': {'https://gedcom.io/terms/v7/record-OBJE': '{1:M}'},
        'contact': 'https://gedcom.io/community/',
    },
    'FORM': {
        'lang': 'en-US',
    ...
    'GEDC-VERS': {
        ...
        'payload': 'http://www.w3.org/2001/XMLSchema#string',
        'substructures': {},
        'superstructures': {'https://gedcom.io/terms/v7/GEDC': '{1:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'GEDC': {
        'lang': 'en-US',
    ...
    'HEAD-PLAC-FORM': {
        ...
        'substructures': {},
        'superstructures': {'https://gedcom.io/terms/v7/HEAD-PLAC': '{1:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'HEAD-PLAC': {
        'lang': 'en-US',
    ...
    'HEIGHT': {
        ...
        'payload': 'http://www.w3.org/2001/XMLSchema#nonNegativeInteger',
        'substructures': {},
        'superstructures': {'https://gedcom.io/terms/v7/CROP': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'HUSB': {
        'lang': 'en-US',
    ...
    'LATI': {
        ...
        'payload': 'http://www.w3.org/2001/XMLSchema#string',
        'substructures': {},
        'superstructures': {'https://gedcom.io/terms/v7/MAP': '{1:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'LEFT': {
        'lang': 'en-US',
    ...
    'MAP': {
        ...
        'superstructures': {'https://gedcom.io/terms/v7/PLAC': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'MARB': {
        'lang': 'en-US',
    ...
    'NAME-TRAN': {
        ...
        'superstructures': {'https://gedcom.io/terms/v7/INDI-NAME': '{0:M}'},
        'contact': 'https://gedcom.io/community/',
    },
    'NAME-TYPE': {
        'lang': 'en-US',
        ...
        'substructures': {'https://gedcom.io/terms/v7/PHRASE': '{0:1}'},
        'superstructures': {'https://gedcom.io/terms/v7/INDI-NAME': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'NAME': {
        'lang': 'en-US',
    ...
    'NO-DATE': {
        ...
        'payload': 'https://gedcom.io/terms/v7/type-Date#period',
        'substructures': {'https://gedcom.io/terms/v7/PHRASE': '{0:1}'},
        'superstructures': {'https://gedcom.io/terms/v7/NO': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'NO': {
        'lang': 'en-US',
    ...
    'PAGE': {
        ...
        'payload': 'http://www.w3.org/2001/XMLSchema#string',
        'substructures': {},
        'superstructures': {'https://gedcom.io/terms/v7/SOUR': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'PEDI': {
        'lang': 'en-US',
    ...
    'PLAC-TRAN': {
        ...
        'label': 'Translation',
        'payload': 'https://gedcom.io/terms/v7/type-List#Text',
        'substructures': {'https://gedcom.io/terms/v7/LANG': '{1:1}'},
        'superstructures': {'https://gedcom.io/terms/v7/PLAC': '{0:M}'},
        'contact': 'https://gedcom.io/community/',
    },
    'PLAC': {
        'lang': 'en-US',
    ...
    'REFN': {
        ...
        'label': 'Reference',
        'payload': 'http://www.w3.org/2001/XMLSchema#string',
        'substructures': {'https://gedcom.io/terms/v7/TYPE': '{0:1}'},
        'superstructures': {
            'https://gedcom.io/terms/v7/record-FAM': '{0:M}',
            'https://gedcom.io/terms/v7/record-INDI': '{0:M}',
            'https://gedcom.io/terms/v7/record-OBJE': '{0:M}',
    ...
    'REPO': {
        ...
        'superstructures': {'https://gedcom.io/terms/v7/record-SOUR': '{0:M}'},
        'contact': 'https://gedcom.io/community/',
    },
    'RESN': {
        'lang': 'en-US',
    ...
    'SEX': {
        ...
        'substructures': {},
        'superstructures': {'https://gedcom.io/terms/v7/record-INDI': '{0:1}'},
        'contact': 'https://gedcom.io/community/',
    },
    'SLGC': {
        'lang': 'en-US',
    ...
    'SUBM-LANG': {
        ...
        'payload': 'http://www.w3.org/2001/XMLSchema#Language',
        'substructures': {},
        'superstructures': {'https://gedcom.io/terms/v7/record-SUBM': '{0:M}'},
        'contact': 'https://gedcom.io/community/',
    },
    'SUBM': {
        'lang': 'en-US',
    ...
    'TAG': {
        ...
        'payload': 'http://www.w3.org/2001/XMLSchema#string',
        'substructures': {},
        'superstructures': {'https://gedcom.io/terms/v7/SCHMA': '{0:M}'},
        'contact': 'https://gedcom.io/community/',
    },
    'TEMP': {
        'lang': 'en-US',
...
ExtensionStructure: dict[str, dict[str, Any]] = {
    '_DATE': {
        'lang': 'en-US',
        'type': 'structure',
        'uri': 'https://github.com/dthaler/gedcom-citations/_DATE',
        'extension tags': ['_DATE'],
        'specification': [
            'Date',
    ...
    '_SOUR': {
        'lang': 'en-US',
        'type': 'structure',
        'uri': 'https://github.com/dthaler/gedcom-citations/_SOUR',
        'extension tags': ['_SOUR'],
        'specification': [
            'Source',
            'This extension tag is a relocated version of the standard\nSOUR tag.\n',
        ],
        'label': 'Source',
        'payload': '@<https://gedcom.io/terms/v7/record-SOUR>@',
        'substructures': {
...
Uri: dict[str, dict[str, Any]] = {
    ...
    'BillionGraves-CemeteryId': {
        ...
        'specification': ['BillionGraves Cemetery ID'],
        'contact': 'GEDCOM@familysearch.org',
    ...
    'BillionGraves-GraveId': {
        ...
        'specification': ['BillionGraves Grave ID'],
        'contact': 'GEDCOM@familysearch.org',
        'change controller': 'BillionGraves.com',
    ...
    'FamilySearch-MemoryId': {
        ...
        'specification': ['FamilySearch Memory ID'],
        'contact': 'GEDCOM@familysearch.org',
        'change controller': 'FamilySearch',
    ...
    'FamilySearch-PersonId': {
        ...
        'specification': ['FamilySearch Person ID'],
        'contact': 'GEDCOM@familysearch.org',
        'change controller': 'FamilySearch',
    ...
    'FamilySearch-PlaceId': {
        ...
        'specification': ['FamilySearch Place ID'],
        'contact': 'GEDCOM@familysearch.org',
        'change controller': 'FamilySearch',
    ...
    'FamilySearch-SourceDescriptionId': {
        ...
        'specification': ['FamilySearch Source Description ID'],
        'contact': 'GEDCOM@familysearch.org',
        'change controller': 'FamilySearch',
        'documentation': [
    ...
    'FamilySearch-UserId': {
        ...
        'specification': ['FamilySearch User ID'],
        'contact': 'GEDCOM@familysearch.org',
        'change controller': 'FamilySearch',
    ...
    'FindAGrave-CemeteryId': {
        ...
        'specification': ['FindAGrave Cemetery ID'],
        'contact': 'GEDCOM@familysearch.org',
    ...
    'FindAGrave-MemorialId': {
        ...
        'specification': ['FindAGrave Memorial ID'],
        'contact': 'GEDCOM@familysearch.org',
        'change controller': 'FindAGrave.com',
        'documentation': [
    ...
    'WikiTree-PersonId': {
        ...
        'specification': ['WikiTree Person ID'],
        'contact': 'GEDCOM@familysearch.org',
