...
class FileTran(BaseStructure):
    ...
    Examples:
        ...
        ...                 gc.Form('audio/mp3'),
        ...                 gc.FileTran(
        ...                     'media/derived.oga', gc.Form('audio/ogg')
        ...                 ),
        ...                 gc.FileTran(
        ...                     'media/transcript.vtt', gc.Form('text/vtt')
        ...                 ),
        ...             ],
        ...         ),
        ...     ],
...
class Head(BaseStructure):
    ...
    Example:
        ...
        ...                 gc.Lang('en-US'),
        ...                 gc.NoteTran(
        ...                     'Diese Datei soll Teile der Spezifikation abdecken und enthält keine aussagekräftigen historischen oder genealogischen Daten.',
        ...                     gc.Lang('de'),
        ...                 ),
...
class IndiFact(BaseStructure):
    ...
    Examples:
        ...
        >>> indi_xref = g.individual_xref('I1')
        >>> indi = gc.RecordIndi(
        ...     indi_xref, gc.IndiFact('Woodworking', gc.Type('Skills'))
        ... )
        >>> print(indi.ged())
        0 @I1@ INDI
        1 FACT Woodworking
...
class Medi(BaseStructure):
    ...
    Examples:
        ...
        >>> m = gc.RecordObje(
        ...     obje_xref,
        ...     gc.File('photo.jpg', gc.Form('image/jpeg', gc.Medi('PHOTO'))),
        ... )
        >>> print(m.ged())
        0 @M1@ OBJE
        1 FILE photo.jpg
...
class NoteTran(BaseStructure):
    ...
    Example:
        ...
        ...     'Arete /Hernandez/',
        ...     gc.Note(
        ...         'Named after Arete from <i>The Odyssey</i>',
        ...         [
        ...             gc.Lang('en'),
        ...             gc.Mime('text/html'),
        ...             gc.NoteTran(
        ...                 'Named after Arete from "The Odyssey"',
        ...                 gc.Mime('text/plain'),
        ...             ),
        ...             gc.NoteTran(
        ...                 'Nombrada en honor a Arete de <i>La Odisea</i>',
        ...                 gc.Lang('es'),
        ...             ),
        ...         ],
        ...     ),
...
class OrdStat(BaseStructure):
    ...
    Examples:
        ...
        >>> import genedata.classes7 as gc
        >>> m = gc.OrdStat('BIC', gc.DateExact('15 JAN 2020'))
        >>> print(m.ged(1))
        1 STAT BIC
        2 DATE 15 JAN 2020
        <BLANKLINE>
...
class Page(BaseStructure):
    ...
    Examples:
        ...
        >>> m = gc.Sour(
        ...     sour_xref, gc.Page('Film: 1234567, Frame: 344, Line: 28')
        ... )
        >>> print(m.ged(2))
        2 SOUR @S1@
        3 PAGE Film: 1234567, Frame: 344, Line: 28
        ...
        >>> m = gc.Dscr(
        ...     'Tall enough his head touched the ceiling',
        ...     gc.Sour(
        ...         Void.SOUR,
...
class Phrase(BaseStructure):
    ...
    Examples:
        ...
        >>> m = gc.Date('24 JUN 1852', gc.Phrase('During the feast of St John'))
        >>> print(m.ged(2))
        2 DATE 24 JUN 1852
        3 PHRASE During the feast of St John
        <BLANKLINE>
        ...
        >>> m = gc.Date('30 JAN 1649', gc.Phrase('30th of January, 1648/9'))
        >>> print(m.ged(2))
        2 DATE 30 JAN 1649
        3 PHRASE 30th of January, 1648/9
        <BLANKLINE>
        ...
        >>> m = gc.Date('BET 1648 AND 1649', gc.Phrase('1648/9'))
        >>> print(m.ged(2))
        2 DATE BET 1648 AND 1649
        3 PHRASE 1648/9
        <BLANKLINE>
        ...
        >>> m = gc.Date('BET 1 JAN 1867 AND 31 MAR 1867', gc.Phrase('Q1 1867'))
        >>> print(m.ged(2))
        2 DATE BET 1 JAN 1867 AND 31 MAR 1867
        3 PHRASE Q1 1867
        <BLANKLINE>
        ...
        >>> m = gc.Marr(
        ...     '', gc.Asso(indi, gc.Role('OTHER', gc.Phrase('Maid of Honor')))
        ... )
        >>> print(m.ged(1))
        1 MARR
        2 ASSO @I2@
...
class PlacTran(BaseStructure):
    ...
    Example:
        ...
        ...         gc.PlacForm('区, 都, 国'),
        ...         gc.Lang('ja'),
        ...         gc.PlacTran('Chiyoda, Tokyo, Nihon', gc.Lang('ja-Latn')),
        ...         gc.PlacTran('Chiyoda, Tokyo, Japan', gc.Lang('en')),
        ...     ],
        ... )
        >>> print(m.ged(2))
        2 PLAC 千代田, 東京, 日本
...
class RecordIndi(BaseStructure):
    ...
    Example:
        ...
        >>> m = gc.RecordIndi(
        ...     indi_i1_xref, gc.Asso(indi_i2_xref, gc.Role('GODP'))
        ... )
        >>> print(m.ged())
        0 @I1@ INDI
        1 ASSO @I2@
...
class Role(BaseStructure):
    ...
    Examples:
        ...
        ...     gc.IndiName(
        ...         'Mary //',
        ...         gc.Sour(sour, gc.SourEven('BIRT', gc.Role('MOTH'))),
        ...     ),
        ... )
        >>> print(m.ged(1))
        0 @I1@ INDI
        ...
        ...     indi2,
        ...     [
        ...         gc.Asso(indi3, gc.Role('FRIEND', gc.Phrase('best friend'))),
        ...         gc.Bapm('', gc.Asso(indi3, gc.Role('WITN'))),
        ...     ],
        ... )
        >>> print(m.ged())
        0 @I2@ INDI
...
class Type(BaseStructure):
    ...
    Examples:
        ...
        >>> g = Genealogy('test')
        >>> indi_xref = g.individual_xref('I1')
        >>> m = gc.RecordIndi(indi_xref, gc.Ordn('', gc.Type('Bishop')))
        >>> print(m.ged())
        0 @I1@ INDI
        1 ORDN
        2 TYPE Bishop
