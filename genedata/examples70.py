...
Examples: dict[str, str] = {
    ...
    Examples:
        ...
        >>> import genedata.classes{Config.VERSION} as {Default.CODE_CLASS_VARIABLE}
    ...
    Example:
        ...
        >>> from genedata.build import Genealogy
        >>> {Default.CODE_GENEALOGY_VARIABLE} = Genealogy()
        >>> snote_xref = {Default.CODE_GENEALOGY}shared_note_xref('GORDON', 
        ...
        >>> import genedata.classes70 as {Default.CODE_CLASS_VARIABLE}
    ...
    Examples:
        ...
        >>> from genedata.methods import Input
        >>> import genedata.classes{Config.VERSION} as {Default.CODE_CLASS_VARIABLE}
        >>> response = {Default.CODE_CLASS}Www(Input.www('abc'))
